...
local infoData = {
    ...
    ["Graphics Stats"] = love.graphics.getStats().texturememory / 1024,
    ["Renderer Info"] = {love.graphics.getRendererInfo()},
    ["Lua Memory"] = collectgarbage("count") * 1024,
    ["Game"] = "Game",
    ["Current State"] = "State"
}
...
function Game:__printDebug()
    ...
    local debugDisplay = "FPS: " .. infoData["FPS"][1] .. " / " .. infoData["FPS"][2] ..
        ...
        "\nGraphics Memory: " .. infoData["Graphics Stats"].texturememory / 1024 ..
